// Grove City Birdie Board Service Worker v1
const CACHE = 'gccc-v3';
const APP_URL = 'https://fairwayhq.github.io/GCCC--BB';
const ICON_URL = 'https://fairwayhq.github.io/GCCC--BB/icons/icon-512.png';
...
self.addEventListener('push', function(e){
  ...
  e.waitUntil(
    self.registration.showNotification(title,{
      body:body, icon:ICON_URL,
      badge:'https://fairwayhq.github.io/GCCC--BB/icons/badge-96.png',
  ...
  e.waitUntil(
    clients.matchAll({type:'window',includeUncontrolled:true}).then(function(clientList){
      for(var i=0;i<clientList.length;i++){
        if(clientList[i].url.indexOf('fairwayhq.github.io/GCCC--BB')!==-1){
          clientList[i].focus(); clientList[i].navigate(url); return;
        }
      }
